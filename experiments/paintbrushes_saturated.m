...
timestep = [0.02, 0.01, 0.01, 0.01, 0.01, 0.01, 0.005, 0.005, 0.005, 0.005];
...
for translationX = minT:stepSizeT:maxT
    for translationY = minT:stepSizeT:maxT
        ...
        for brush_iter = 7:length(diameter)
%             display(sport{ball_iter});
            ...
            filename = strcat('paintbrush',num2str(diameter),'_translationx',...
            ...
            brush = setObjPosition(brush,[0;0;diameter(brush_iter)/2+0.022]);
